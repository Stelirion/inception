...
wp post create --post_type='post' --post_status=publish --post_title='UwU' --post_content="Salut j'aime les pates et le tiramisu" --post_thumbnail_id=7 --post_author=2 --allow-root
